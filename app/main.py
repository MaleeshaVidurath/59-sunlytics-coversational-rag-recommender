...
class PipelineRequest(BaseModel):
    ...
    """
    retrieval_input: Optional[Dict[str, Any]] = None   # None indicates FEEDBACK or CHITCHAT actions
    memory_context: Optional[Dict[str, Any]] = {}      # Contains user prefs, dialogue state, and feedback
